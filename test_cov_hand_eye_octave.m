...
partial_v_q_sym_func = matlabFunction(partial_v_q_sym, q_);
[partial_v_q_sym_val, ~] = partial_v_q_sym_func(q(1), q(2), q(3), q(4));

partial_y_q_sym = jacobian(y_, q_);
partial_y_q_sym_func = matlabFunction(partial_y_q_sym, q_);
[partial_y_q_sym_val, ~] = partial_y_q_sym_func(q(1), q(2), q(3), q(4));
